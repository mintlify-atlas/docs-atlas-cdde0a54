---
title: "Running Ladybird in Headless Mode for CI and Testing"
sidebarTitle: "Headless Mode"
description: "How to run Ladybird without a GUI window for automated testing, screenshot generation, and layout tree inspection using --headless and --test-mode flags."
---
